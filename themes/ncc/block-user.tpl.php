<?php
// $Id: block-user.tpl.php,v 1.4 2008/09/14 12:41:20 johnalbin Exp $

/**
 * @file block-user.tpl.php
 *
 * Theme implementation to display a user block.
 *
 * Available variables:
...
<div id="block-<?php print $block->module . '-' . $block->delta; ?>" class="<?php print $classes; ?>"><div class="block-inner">
  ...
  <?php if ($block->subject): ?>
    <?php if($block->subject == "User login"): ?>
    	...
    	<div style="padding: 0 0 0 10px;">. . . for custom information and content filtered to <b>your</b> needs.</div>
    <?php else:?>
